public class GameObjects 
{
	private static Item[] allItems = {
			new Item("Potion", "Restores 150 HP", 100, 1),
			
			new Item("Big Potion", "Restores 500 HP", 625, 2), 
			
			new Item("Max Potion", "Restores all HP", 1500, 3),
			
			new Item("Magic Bottle", "Restores 50 MP", 450, 4), 
			
			new Item("Magic Pot", "Restores all MP", 1000, 5),
			
			new Item("Warp Panel", "Warps out of dungeon back to shop", 400, 6)
